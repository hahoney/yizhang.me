...
# Comment by Yi Zhang
# The loader module load models or modules for database access 
# according to the name and type given in Loader
# For example:
# loader = Loader(self.db)
# loader.use(model.type) initializes name and type 
# the use method call loader method depending on type
# and return the method as a variable in loaded{map {map}}
